...
이 저장소는 4명이 함께 Unity와 C#을 학습하며 실제 게임을 구현하는 스터디 프로젝트입니다.  
...
이 프로젝트는 Unity 엔진과 C# 언어를 활용해 게임을 직접 제작하며 학습하는 스터디 기록용 저장소입니다.

스터디 목적  
새로운 기술 스택에 대한 두려움 줄이기  
문서나 강의 없이도 스스로 학습하고 적응할 수 있는 역량 증명
...
선택 이유  
게임을 좋아하는 공통 관심사를 기반으로 실제 제작 위주의 학습을 진행하기 위해 선택
...
진행 방식  
Discord를 통해 온라인 모임 후 화면 공유 기반 학습 진행  
챕터 단위로 실습을 수행하며 문제 발생 시 함께 해결

협업 방식  
역할 분담 없이 동일한 내용을 각자 구현  
코드를 비교하며 개선 사항 도출

코드 공유 방식  
Discord 및 카카오톡을 통한 코드 공유  
...
현재 학습 및 구현을 진행 중이며 내용은 지속적으로 업데이트됩니다.
...
- ⚙️ [구현 진행 현황](#5-구현-진행-현황-implementation-progress)
